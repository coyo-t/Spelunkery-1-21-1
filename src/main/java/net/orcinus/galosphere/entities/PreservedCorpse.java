...
public class PreservedCorpse extends Monster
{
	...
	@Override
	protected Brain.Provider<PreservedCorpse> brainProvider ()
	{
	...
	@Override
	public Brain<PreservedCorpse> getBrain ()
	{
		return (Brain<PreservedCorpse>)super.getBrain();
	}
