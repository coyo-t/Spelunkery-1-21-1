...
//		for (var recipe: list)
//		{
//			ResourceLocation target = ResourceLocation.tryBuild(targetNamespace, targetPath + recipe);
//			ResourceLocation source = ResourceLocation.tryBuild("spelunkery", sourcePath + recipe + ".json");
//
...
//		for (var recipe: list)
//		{
//			var target = ResourceLocation.tryBuild(targetNamespace, targetPath + recipe + ".json");
//			var source = ResourceLocation.tryBuild("spelunkery", sourcePath + recipe + ".json");
//
//			try (var bsStream = manager.getResource(source).orElseThrow().open())
//			{
//				JsonElement bsElement = RPUtils.deserializeJson(bsStream);
